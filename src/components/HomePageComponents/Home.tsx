      ...
      <div className={"flex flex-wrap items-center justify-center"}>
        <div className="flex items-center gap-8 tableHeaderChild1 md:justify-center">
          ...
          <div
            ...
            className=" items-center gap-2 hidden lg:flex cursor-pointer border rounded w-64 justify-center h-10"
          >
            <p>Currency</p>
          ...
          <div className={"  w38rem hidden lg:block"}>
            {currencyModal && (
              <div className={styles.currencyModalHold}>
                <div>
        ...
        <div className="flex gap-8 flex-wrap items-center ml-2 md:justify-center justify-around mt-5 md:mt-0">
          <p
            className={`${
              tabState === "all coins"
                ? "flex justify-center items-center w-24 h-9 rounded-md border border-black cursor-pointer interFont scalee"
                : "flex justify-center items-center w-24 h-9 rounded-md greyBackground cursor-pointer interFont scalee"
            }`}
          ...
          <p
            className="flex justify-center items-center w-32 h-9 rounded-md greyBackground cursor-pointer interFont scalee gap-2"
            onClick={onOpen}
          >
            {" "}
            <AiOutlineStar className="text-xl" /> Favourites{" "}
          </p>
        </div>
      </div>
      ...
      <div className="overflow-x-auto">
        {cryptoData.length === 0 ? (
          <p className=" font-semibold flex justify-center items-center mb-4 gap-2">
            No Results Found{" "}
            <RxCrossCircled className=" font-bold align-middle text-2xl text-red-600" />
          </p>
        ) : (
                  ...
                  <tr key={coin.id}>
                    <th>
                      <div className="w-8 h-8 cursor-pointer">
                        <AiOutlineStar
                          className="sm:text-xl text-xl text-gray-500 hover:text-yellow-500 transition-all ease-in"
                    ...
                    <td className="py-6 cursor-pointer">
                      <Link href={`/${coin.id}`}>
                        <img
                          ...
                          alt="ada"
                        />
                        <span className="font-semibold inline-block align-middle uppercase sm:text-base text-sm mr-4">
                    ...
                    <td className=" font-semibold py-6 sm:text-base text-sm">
                      ...
                      {currency == "usd" ? (
                        ...
                        <BiRupee className=" inline-block"></BiRupee>
                      )}{" "}
                    ...
                    <td
                      className={
                        coin.price_change_percentage_24h > 0
                          ? "text-green-600 sm:text-base text-sm font-semibold py-6 inline-block align-middle"
                          : "text-red-600 font-semibold py-6 inline-block align-middle"
                      }
                    >
                      {" "}
                      <span className=" inline-block align-middle">
                        {" "}
                        {coin.price_change_percentage_24h > 0 ? (
                          <FiTrendingUp className="text-semibold text-xl text-green-600" />
                        ) : (
                          <FiTrendingDown className="text-semibold text-xl text-red-600" />
                        )}{" "}
                      </span>{" "}
        ...
        <DrawerContent>
          <DrawerHeader borderBottomWidth="1px">
            ...
            <div className="flex gap-2">
              ...
              <AiFillStar className="golden font-bold text-3xl" />{" "}
            </div>{" "}
          </DrawerHeader>
          <DrawerBody>
            <br />
