...
const CoinDetailHero = (props: any) => {
  ...
  const fetchDataHandler = async () => {
    ...
    try {
      ...
      if (!response1.ok) {
        throw new Error(
          `Error fetching coin detail data: ${response1.status} ${response1.statusText}`
        );
      }
    ...
    try {
      ...
      if (!response2.ok) {
        throw new Error(
          `Error fetching trending coins data: ${response2.status} ${response2.statusText}`
        );
      }
    ...
    <div>
      {coinDetailData && coinDetailData.market_data ? (
        <div>
              ...
              <nav className="container interFont lg:ml-20">
                <ol className="list-reset py-4 pl-1 rounded flex bg-grey-light text-grey">
                  <li className="px-2 text-gray-400">
                    <a className="no-underline text-indigo">Cryptocurrencies</a>
                  </li>
                  <li>/</li>
                  <li className="px-2 text-gray-400">
                    <a className="no-underline text-indigo">Coins</a>
                  </li>
                  <li>/</li>
                  ...
                  <li className="px-2 text-gray-400">
                    <Link
                      href={"/"}
                      className="no-underline text-indigo hover:underline"
                    >
                      Home
                    </Link>
                  </li>
                  ...
                  <div className="flex items-center gap-6">
                    {
                      <img
                        ...
                        className=" md:w-28 w-24 rounded-full boxsh2"
                        alt="ada"
                      />
                    }
                    <div className="flex flex-col gap-8 items-center -ml-4">
                      <p className=" font-normal text-xl uppercase">
                        {" "}
                        {coinDetailData.id}{" "}
                        <span className=" text-gray-400 font-normal text-sm relative -top-4">
                          {" "}
                          ...
                          {coinDetailData.market_data.price_change_24h < 0 ? (
                            <div className="flex items-center justify-end relative -top-14 left-5">
                              <span className="text-sm">
                                {coinDetailData.market_data.price_change_24h.toFixed(
                                  0
                                )}
                                $
                              </span>
                              ...
                              <div>
                                <div className="flex gap-6 flex-wrap">
                                  <img
                                    src={coin.item.small}
                                    alt=""
                                    className="bg-white rounded-full w-16 boxsh2"
                                  />
          ...
          {trendingCoinsData.length > 0 && (
            <div className="coinDetailTagsHold ml-4 md:flex-col flex-row flex w37percent items-center lg:flex">
              <div className="flex items-center gap-4 justify-start w48percent w-full flex-wrap mt-3">
                {coinDetailData.categories && coinDetailData.categories[0] && (
                  <p className="bg-gray-200 w-auto pl-3 pr-3 flex justify-center boxsh items-center rounded h-auto pt-2 pb-1">
                    {" "}
                    {coinDetailData.categories[0]}{" "}
                  </p>
                )}
                {coinDetailData.categories && coinDetailData.categories[1] && (
                  <p className="bg-gray-200 w-auto pl-3 pr-3 flex justify-center boxsh items-center rounded h-auto pt-2 pb-1">
                    {" "}
            ...
            <div className="coinDetailTagsHold ml-4 md:flex-col flex-row flex w37percent items-center lg:flex">
              <div className="flex items-center gap-4 justify-start w48percent w-full flex-wrap mt-3">
                {coinDetailData.links && coinDetailData.links.homepage[0] && (
                  <Link
                    href={`${coinDetailData.links.homepage[0]}`}
                    target="_blank"
                    className="bg-gray-200 w-auto pl-3 pr-3 flex justify-center items-center rounded-full h-9 boxsh"
                  >
                    {" "}
                    <IoHome />{" "}
                  </Link>
                )}
                {coinDetailData.links &&
                  coinDetailData.links.repos_url.github[0] && (
                    <Link
                      href={`${coinDetailData.links.repos_url.github[0]}`}
                      target="_blank"
                      className="bg-gray-200 w-auto pl-3 pr-3 flex justify-center items-center rounded-full h-9 boxsh"
                    >
                      {" "}
                ...
                {coinDetailData.links && coinDetailData.links.subreddit_url && (
                  <Link
                    href={`${coinDetailData.links.subreddit_url}`}
                    target="_blank"
                    className="bg-gray-200 w-auto pl-3 pr-3 flex justify-center items-center rounded-full h-9 boxsh"
                  >
                    {" "}
          ...
          {trendingCoinsData.length > 0 && (
            <div className="coindDetailStats1Hold pr-4 pl-4 hidden lg:flex items-center justify-evenly flex-wrap gap-10">
              <div className="coinDetailStat1Hold items-center flex flex-col gap-8">
                ...
                <div className="pl-3">
                  <div className="flex items-center gap-2">
                    <span className="text-2xl font-semibold text-gray-400 interFont">
                      $
                    </span>
                    {coinDetailData.market_data &&
                      coinDetailData.market_data.market_cap.usd && (
                        <p className=" font-semibold statHeading interFont">
                          {" "}
              ...
              <div className="coinDetailStat1Hold items-center flex flex-col gap-8">
                <p className="text-xl font-semibold w-full pl-4">
                  Fully Diluted
                </p>
                <div className="">
                  <div className="flex items-center gap-2">
                    ...
                    {coinDetailData.market_data &&
                      coinDetailData.market_data.fully_diluted_valuation
                        .usd && (
                        <p className=" font-semibold statHeading interFont">
                          {" "}
                          {coinDetailData.market_data.fully_diluted_valuation.usd.toLocaleString()}{" "}
                        </p>
                      )}
                  </div>
                </div>
              ...
              <div className="coinDetailStat1Hold items-center flex flex-col gap-8">
                ...
                <div className="pl-3">
                  <div className="flex items-center gap-2">
                    ...
                    {coinDetailData.market_data &&
                      coinDetailData.market_data.total_volume.usd && (
                        <p className=" font-semibold statHeading interFont">
                          {" "}
              ...
              <div className="coinDetailStat1Hold items-center flex flex-col gap-8">
                ...
                <div className="pl-3">
                  <div className="flex items-center gap-2">
                    ...
                    {coinDetailData.market_data &&
                      coinDetailData.market_data.circulating_supply &&
                      coinDetailData.symbol && (
                        <p className=" font-semibold statHeading interFont">
                          ...
                          <span className=" text-gray-300 font-normal uppercase">
                            {" "}
                            {coinDetailData.symbol}{" "}
                          </span>{" "}
                        </p>
          ...
          {trendingCoinsData.length > 0 && (
            <CoinDetailChart
              cryptoName={coinName}
              specificCoinDetails={coinDetailData}
            />
          )}
        </div>
      ) : (
